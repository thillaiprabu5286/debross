	 ...
	 */
	 function _import( $file_url ) {
		...
		if ( 'array' != gettype( $data ) ) {
			esc_html_e( 'Error importing settings! Please check that you uploaded a customizer export file.', 'axle-demo-importer' );
			return;
		}
		...
		if ( $data['template'] != $template ) {
            esc_html_e( 'Error importing settings! The settings you uploaded are not for the current theme.', 'axle-demo-importer' );
			return;
		}
		...
		if ( isset( $data['options'] ) ) {
			...
			foreach ( $data['options'] as $option_key => $option_value ) {
				...
				$option = new ADI_DAT_CEI_Option( $wp_customize, $option_key, array(
					'default'		=> '',
					'type'			=> 'option',
...
final class ADI_DAT_CEI_Option extends WP_Customize_Setting {
