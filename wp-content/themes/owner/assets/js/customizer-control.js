jQuery(document).ready(function($) {
    ...
    $('#customize-info .preview-notice').append(
        ...
        '<a class="pro-theme-info" href="https://mysterythemes.com/wp-themes/owner-pro/" target="_blank">View Pro</a>'+
        '<a class="pro-theme-info" href="http://demo.mysterythemes.com/owner-pro-landing/" target="_blank">View Pro Demo</a>'+
        '</div>'
    );
});