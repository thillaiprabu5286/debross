        ...
        case 'upload':
            ...
            <label for="<?php echo esc_attr( $instance->get_field_id( $owner_widgets_name ) ); ?>"><?php echo esc_html( $owner_widgets_title ); ?>:</label><br />
                ...
                <div class="actions clearfix">
                    <button type="button" class="button mt-delete-button align-left"><?php _e( 'Remove', 'owner' ); ?></button>
                    <button type="button" class="button mt-upload-button alignright"><?php _e( 'Select Image', 'owner' ); ?></button>
