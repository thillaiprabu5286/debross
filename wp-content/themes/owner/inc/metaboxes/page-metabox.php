				...
				<div class="mt-single-meta" id="mt-metabox-sidebar">
					...
					<div class="mt-meta-options-wrap">
						<div class="buttonset">
			                ...
			                ?>
			                    	<input type="radio" id="<?php echo esc_attr( $field['id'] ); ?>" value="<?php echo $field['value']; ?>" name="single_page_sidebar" <?php checked( $field['value'], $owner_page_sidebar ); if( empty( $owner_page_sidebar ) && $field['value'] == 'default_sidebar' ){ echo "checked='checked'";}  ?> />
