...
?>
		<div class="mt-meta-container clearfix">
			<ul class="mt-meta-menu-wrapper">
				<li class="mt-meta-tab <?php if( $post_identity_value == 'mt-metabox-info' ) { echo 'active'; } ?>" data-tab="mt-metabox-info"><span class="dashicons dashicons-clipboard"></span><?php _e( 'Information', 'owner' ); ?></li>
				<li class="mt-meta-tab <?php if( $post_identity_value == 'mt-metabox-sidebar' ) { echo 'active'; } ?>" data-tab="mt-metabox-sidebar"><span class="dashicons dashicons-exerpt-view"></span><?php _e( 'Sidebars', 'owner' ); ?></li>
			...
			<div class="mt-metabox-content-wrapper">
				...
				<div class="mt-single-meta active" id="mt-metabox-info">
					<div class="content-header">
						<h4><?php _e( 'About Metabox Options', 'owner' ) ;?></h4>
					</div><!-- .content-header -->
				...
				<div class="mt-single-meta" id="mt-metabox-sidebar">
					<div class="content-header">
						<h4><?php _e( 'Available Sidebars', 'owner' ) ;?></h4>
						<span class="section-desc"><em><?php _e( 'Select sidebar from available options which replaced sidebar layout from customizer settings.', 'owner' ); ?></em></span>
					</div><!-- .content-header -->
					<div class="mt-meta-options-wrap">
						<div class="buttonset">
			                ...
			                ?>
			                    	<input type="radio" id="<?php echo esc_attr( $field['id'] ); ?>" value="<?php echo $field['value']; ?>" name="single_post_sidebar" <?php checked( $field['value'], $owner_post_sidebar ); if( empty( $owner_post_sidebar ) && $field['value'] == 'default_sidebar' ){ echo "checked='checked'";}  ?> />
