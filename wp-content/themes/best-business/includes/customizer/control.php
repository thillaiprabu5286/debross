 ...
 */
class Best_Business_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'best-business' );
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'best-business-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Best_Business_Dropdown_Sidebars_Control extends WP_Customize_Control {
